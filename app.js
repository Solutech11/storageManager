...
//connecting datbase
mongoose.connect("mongodb+srv://Solutech:Xerewgida@cluster0.whfg7.mongodb.net/StorageManager?retryWrites=true&w=majority",{useNewUrlParser:true,useUnifiedTopology:true}).then((result)=>{
    if (result){
